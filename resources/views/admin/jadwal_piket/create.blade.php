    ...
    <div class="p-4 sm:p-6 lg:p-8">
        <div class="max-w-xl mx-auto"> {{-- Batasi lebar form --}}
            ...
            <div class="bg-white p-6 rounded-xl shadow-md border border-gray-200">
                <form method="POST" action="{{ route('admin.picket_schedules.store') }}" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <select name="hari_ke" id="hari_ke" required
                            ...
                            <option value="1" {{ old('hari_ke') == '1' ? 'selected' : '' }}>Senin</option>
                            <option value="2" {{ old('hari_ke') == '2' ? 'selected' : '' }}>Selasa</option>
                            <option value="3" {{ old('hari_ke') == '3' ? 'selected' : '' }}>Rabu</option>
                            <option value="4" {{ old('hari_ke') == '4' ? 'selected' : '' }}>Kamis</option>
                            <option value="5" {{ old('hari_ke') == '5' ? 'selected' : '' }}>Jumat</option>
                            <option value="6" {{ old('hari_ke') == '6' ? 'selected' : '' }}>Sabtu</option>
                            <option value="7" {{ old('hari_ke') == '7' ? 'selected' : '' }}>Minggu</option>
                        </select>
                        @error('hari_ke')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    {{-- Jam Mulai & Jam Selesai (dalam satu baris jika muat) --}}
                    ...
                    <div>
                        ...
                        <textarea id="keterangan_tugas" name="keterangan_tugas" rows="3"
                            ...
                            placeholder="Contoh: Mengawasi gerbang utama, penanganan siswa terlambat, dll.">{{ old('keterangan_tugas') }}</textarea>
                    ...
                    <div class="flex justify-end space-x-3 pt-4 border-t mt-8">
                        ...
                        <button type="submit"
                            ...
                            <i data-lucide="save" class="w-4 h-4 mr-1.5 -ml-1"></i>Simpan Jadwal
                        </button>
                    </div>
                </form>
            </div>
