    ...
    <div class="p-4 sm:p-6 lg:p-8 space-y-6">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
            ...
            @if (Auth::user()->isSuperAdmin())
                ...
                <a href="{{ route('admin.picket-schedules.create') }}" class="btn-primary">
        ...
        <div class="bg-white p-4 rounded-xl shadow-md border border-gray-200 mb-6">
            <form method="GET" action="{{ route('admin.picket-schedules.index') }}" class="flex flex-wrap items-end gap-4">
                ...
                {{-- Tombol Tampilkan --}}
                <div>
                    <button type="submit" class="btn-primary py-2 px-4">Tampilkan</button>
                </div>
                {{-- Tombol Bulan Ini (opsional) --}}
                <div>
                    <a href="{{ route('admin.picket-schedules.index') }}" class="btn-secondary py-2 px-4">Bulan Ini</a>
                </div>
            </form>
        </div>
